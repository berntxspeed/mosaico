...
var lsCommandPluginFactory = function(md, emailProcessorBackend) {
  var commandsPlugin = function(mdkey, mdname, viewModel) {
    //only configure save function if not already configured, like by plugins passed to Mosaico.init()
    if (typeof viewModel.save == 'undefined'){
      var saveCmd = {
    ...
    if (typeof viewModel.test == 'undefined'){
      var testCmd = {
    ...
    if (typeof viewModel.download == 'undefined'){
      var downloadCmd = {
